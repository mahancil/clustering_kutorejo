				...
				<div class="hero-wrap">
					...
					<div class="d-flex">
						...
						<div class="author-info text col-md-12">
							<div class="desc">
								<h1 class="mb-4"><span>Tambah Penyakit</span></h1>
									<div class="col-md-12">
							            <div class="bg-light p-5 contact-form">
							            	<?php echo form_open_multipart('tambah_penyakit_cnt/createAction'); ?>
							            	
							              <div class="form-group">
							              	<h4>Nama Penyakit</h4>
							               <input type="text" class="custom-control" placeholder="Penyakit" name="penyakit">
							              </div>
							              <div class="row">
