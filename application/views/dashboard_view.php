	...
	<div id="colorlib-page">
		...
		<aside id="colorlib-aside" role="complementary" class="js-fullheight text-center">
			...
			<nav id="colorlib-main-menu" role="navigation">
				<ul>
					<li class="colorlib-active"><a href="<?php echo base_url(); ?>index.php/dashboard_cnt">Dasboard</a></li>
				...
				<div class="hero-wrap">
					...
					<div class="d-flex">
						...
						<div class="author-info text col-md-12">
							<div class="desc">
								<h1 class="mb-4"><span>Dashboard</span></h1>
									<div class="col-md-12">
							            <div class="bg-light p-5 contact-form">
								            <center><h3>PENERAPAN ALGORITMA K-MEANS UNTUK MENENTUKAN TINGKAT KESEHATAN  BALITA PADA PUSKESMAS KECAMATAN KUTOREJO KABUPATEN MOJOKERTO</h3></center>
								            <center><h4>Oleh:</h4></center>
								            <center><h4>Fahmi Karisma Yuda - 1541180152</h4></center>
								            <br>
								            <center><a href="<?php echo base_url(); ?>index.php/upload_cnt"><button class="btn btn-primary py-3 px-5">Lanjut</button></a></center>
