				...
				<div class="hero-wrap">
					...
					<div class="d-flex">
						...
						<div class="author-info text col-md-12">
							<div class="desc">
								<h1 class="mb-4"><span>Warning</span></h1>
									<div class="col-md-12">
							            <div class="bg-light p-5 contact-form">
								            <center><h3>Upload file hanya dengan file .csv</h3></center>
								            <br>
								            <center><a href="<?php echo base_url(); ?>index.php/upload_cnt"><button class="btn btn-primary py-3 px-5">Kembali</button></a></center>
