				...
				<div class="hero-wrap">
					...
					<div class="d-flex">
						...
						<div class="author-info text col-md-12">
							<div class="desc">
								<h1 class="mb-4"><span>Normalisasi Data</span></h1>
									<div class="col-md-12">
							            <!-- <div class="bg-light p-5 contact-form"> -->
							            	<div class="form-group">
							                <a href="<?php echo base_url(); ?>index.php/clustering_cnt/kalkulasi/<?php echo $jumlah_penyakit[0] ?>"><button class="btn btn-primary py-3 px-5">Lanjut</button></a>
							              </div>
