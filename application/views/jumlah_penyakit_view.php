				...
				<div class="hero-wrap">
					...
					<div class="d-flex">
						...
						<div class="author-info text col-md-12">
							<div class="desc">
								<h1 class="mb-4"><span>Jumlah Penyakit</span></h1>
									<div class="col-md-12">
							            <div class="bg-light p-5 contact-form">
							            	<?php echo form_open_multipart('upload_cnt/form_data'); ?>
							              <div class="form-group">
							              	<h4>Masukkan Jumlah Penyakit Yang Akan Diproses!</h4>
							               <input type="text" class="custom-control" placeholder="Jumlah Penyakit" name="jumlahpenyakit">
							              </div>							              
							              <div class="row">
